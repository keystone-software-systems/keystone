  ...
  return (
    <div className="mx-auto max-w-3xl px-6 py-20">
      ...
      <div className="mt-8 flex flex-col gap-6 text-lg text-graphite/70">
        <p>
          I&apos;ve been the engineer responsible for the kind of systems you&apos;re now
          evaluating, starting as an intern at Microsoft and reaching Senior Software Engineer
          within three years of joining full-time, then building core payments infrastructure as
          a senior engineer at Stripe on systems that processed billions of dollars in
          transactions a day, then back to Microsoft as a Principal Software Engineer (
          <a
          ...
          ). I know what production-grade actually looks like, and what it looks like when a
          system is held together by habit rather than design.
        </p>
        <p>
      ...
      <div className="mt-12 border-t border-ash/20 pt-10">
